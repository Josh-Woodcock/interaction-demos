namespace VRTK.Examples.Archery
{
    ...
    public class ArrowSpawner : MonoBehaviour
    {
        ...
        {
            VRTK_InteractGrab grabbingController = (gameObject.GetComponent<VRTK_InteractGrab>() ? gameObject.GetComponent<VRTK_InteractGrab>() : gameObject.GetComponentInParent<VRTK_InteractGrab>());
